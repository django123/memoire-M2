...
\documentclass[14pt,A4,french,oneside,leqno]{report}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		\multirow La conception et la modélisation de l’application web      & \multirow{Analyse des besoins}      & \parbox{0.2\linewidth}{Collecte information sur les 
			besoins fonctionnels concernant relatif au courrier}      &  Un jour    \\ \cline{3-4} 
		&                             &   \parbox{0.2\linewidth}{Collecte information sur les besoins fonctionnels concernant relatif au courrier}  &   Une semaine    \\ \cline{2-4} 
		& \multirow{Modélisation} &   Diagramme de classe     &   Une semaine  \\ \cline{3-4} 
		&                              &      \parbox{0.2\linewidth}{Validation du Diagramme de classe} &  un jour    \\ \cline{3-4} 
		&                               &   Diagramme d’objet     & Trois jours      \\ \cline{3-4} 
		&                               &   \parbox{0.2\linewidth}{Validation du Diagramme d'objet}      & un jour      \\ \cline{3-4} 
		&                               &   \parbox{0.2\linewidth}{diagramme de séquence et Validation du Diagramme de séquence}      &    Quatre jours   \\ \hline
		\multirow{Implémentation} & \multirow{Codage}       &  \parbox{0.2\linewidth}{Développement des codes de l’application (Back – End)}     &    trois semaines   \\ \cline{3-4} 
		&                              & \parbox{0.2\linewidth}{Développement « vue \\utilisateur » (Front-end)}       &   Trois semaines    \\ \cline{2-4} 
		& Tests                          &  \parbox{0.2\linewidth}{Tests de la fonctionnalité de l’application}      &   deux semaines    \\ \hline
		\multirow{Présentation, formation et finalisation de l’application}   & \multirow{Présentation de l’application} & \parbox{0.2\linewidth}{Présentation du module suivi et archivage du courrier}       &    un jour   \\ \cline{3-4} 
		&                               &   \parbox{0.2\linewidth}{Présentation du module suivi des projets et archivage des documents de projet}        &   un jour    \\ \cline{2-4} 
		&Finalisation de l’application                  & \parbox{0.2\linewidth}{Prise en compte des observations effectuées au cours de la présentation}       &  une semaine     \\ \cline{2-4} 
